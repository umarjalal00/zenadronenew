...
const ORBS = [
  { x: 20, y: 30, w: 480, h: 480, color: '#34d399', op: 0.055, d: 9  },
  { x: 72, y: 55, w: 380, h: 380, color: '#00d4ff', op: 0.045, d: 12 },
  { x: 50, y: 10, w: 280, h: 280, color: '#a78bfa', op: 0.035, d: 7  },
]
  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <input
        ...
        onFocus={e => { e.currentTarget.style.borderColor = 'rgba(52,211,153,0.35)'; e.currentTarget.style.boxShadow = '0 0 0 3px rgba(52,211,153,0.06)' }}
...
export function IQNanoCTA() {
  ...
  return (
    <section ref={sectionRef} id="iq-nano-demo" className="relative w-full py-28 md:py-40 overflow-hidden bg-background">
      {/* Orbs */}
      {ORBS.map((o, i) => (
        <div key={i} className="absolute pointer-events-none" style={{
          ...
          opacity: o.op,
          filter: 'blur(60px)',
          animation: `iqnCtaOrb ${o.d}s ease-in-out infinite`,
      ...
      {/* Animated beam */}
      <div className="absolute inset-y-0 w-px pointer-events-none iqn-cta-beam" style={{
        background: 'linear-gradient(to bottom, transparent, rgba(52,211,153,0.55) 40%, rgba(52,211,153,0.75) 50%, rgba(52,211,153,0.55) 60%, transparent)',
      ...
      <Container size="lg">
        <FadeIn className="text-center mb-14">
          <p className="font-mono font-bold uppercase tracking-[0.28em] mb-4" style={{ fontSize: '0.8125rem', color: '#34d399' }}>
            Get Started
          </p>
          <h2 className="font-display font-bold text-white mb-5" style={{ fontSize: 'clamp(2.5rem, 5.4vw, 4.2rem)', letterSpacing: '-0.03em', lineHeight: 1.05 }}>
            Book a{' '}
          ...
          <p className="font-sans text-text-muted mx-auto" style={{ fontSize: '1.125rem', maxWidth: 540, lineHeight: 1.7 }}>
            Witness the ZenaDrone IQ Nano&apos;s operation up close. Please complete the form, and our team will contact you to schedule a personalized demo.
          </p>
        </FadeIn>
        ...
        <FadeIn delay={0.1}>
          <div className="relative p-8 md:p-10 rounded-3xl" style={{
            ...
            {/* Corner glows */}
            <div className="absolute top-0 left-0 w-36 h-36 pointer-events-none" style={{ background: 'radial-gradient(ellipse at top left, rgba(52,211,153,0.1) 0%, transparent 70%)' }} />
            ...
            {submitted ? (
              ...
              >
                ...
                <p className="font-sans text-text-muted" style={{ fontSize: '0.92rem' }}>
                  Our team will contact you within 24 hours to schedule your ZenaDrone IQ Nano demo.
                </p>
              </motion.div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <TextareaField
                  ...
                  name="message"
                  placeholder="Describe your warehouse setup, current inventory processes, and what you'd like to improve with the ZenaDrone IQ Nano..."
                  value={form.message}
                  onChange={handleChange}
                />
        ...
        <FadeIn delay={0.2} className="flex flex-wrap justify-center gap-6 mt-10">
          {['GPS-Free Indoor', 'SAP Integrated', 'AWS Cloud', 'Auto-Docking'].map(item => (
            <div key={item} className="flex items-center gap-2">
              <div className="w-1 h-1 rounded-full opacity-60" style={{ background: '#34d399' }} />
      ...
      <style>{`
        @keyframes iqnCtaOrb { 0%,100% { transform: translate(-50%,-50%) scale(1); } 50% { transform: translate(-50%,-50%) scale(1.12); } }
      `}</style>
    </section>
  )
}
